...
export default function PortalHome({ token, polizas, onIrAPolizas, onIrACuponera }) {
  ...
  // 🔎 DIAGNÓSTICO: muestra en consola TODOS los campos de la próxima cuota,

  //    para ver dónde viene el id (o si no viene). Sacar cuando funcione.

  if (proxima) {

    // eslint-disable-next-line no-console

    console.log("[MP-portal] próxima cuota (campos):", proxima.cuota);
      ...
      {proxima ? (
        ...
        >
          ...
          <div className="relative z-10">
            ...
            {/* id de la cuota tolerante: puede venir como id, cuota_id o pk. */}
